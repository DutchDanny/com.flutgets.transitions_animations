...
class SharedAxisTransitionDemo extends StatefulWidget {
  ...
  @override
  SharedAxisTransitionDemoState createState() =>
      SharedAxisTransitionDemoState();
}

class SharedAxisTransitionDemoState extends State<SharedAxisTransitionDemo> {
...
class _CourseSwitch extends StatefulWidget {
  ...
  @override
  CourseSwitchState createState() => CourseSwitchState();
}

class CourseSwitchState extends State<_CourseSwitch> {
  bool _value = true;
      ...
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        return Column(
          children: <Widget>[
            ...
            Image.asset('assets/images/avatar_logo.png', width: 80),
