...
class FadeThroughTransitionDemo extends StatefulWidget {
  ...
  @override
  FadeThroughTransitionDemoState createState() =>
      FadeThroughTransitionDemoState();
}

class FadeThroughTransitionDemoState extends State<FadeThroughTransitionDemo> {
  int pageIndex = 0;
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      itemBuilder: (BuildContext context, int index) {
        return ListTile(
          leading: Image.asset('assets/images/avatar_logo.png', width: 40),
