...
class OpenContainerTransformDemo extends StatefulWidget {
  ...
  @override
  OpenContainerTransformDemoState createState() =>
      OpenContainerTransformDemoState();
}

class OpenContainerTransformDemoState
          ...
          ...List<Widget>.generate(10, (int index) {
            return OpenContainer<bool>(
              ...
              closedBuilder: (BuildContext _, VoidCallback openContainer) {
                return ListTile(
                  leading:
                      Image.asset('assets/images/avatar_logo.png', width: 40),
                  onTap: openContainer,
      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            ...
            child: Center(
              child:
                  Image.asset('assets/images/placeholder_image.png', width: 80),
            ),
          ),
          Expanded(
            child: Padding(
      ...
      child: Row(
        children: <Widget>[
          Container(
            ...
            child: Center(
              child:
                  Image.asset('assets/images/placeholder_image.png', width: 60),
            ),
          ),
          Expanded(
            child: Padding(
